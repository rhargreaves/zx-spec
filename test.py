...
class TestPasses(unittest.TestCase):
    ...
    def test_zx_spec_header_displayed(self):
        self.assertRegex(self.output, "ZX Spec v")

    def test_marks_show_tests_passed(self):
        self.assertRegex(self.output.replace("\n", ""), "\." * self.num_tests)

    def test_all_tests_pass(self):
        self.assertRegex(
            self.output, "Pass: {0}, Fail: 0, Total: {0}".format(self.num_tests)
        )

    def test_framework_exited_correctly(self):
        self.assertRegex(self.output, ZX_SPEC_TEST_END_MARKER)
...
class TestFailures(unittest.TestCase):
    ...
    def test_shows_failed_tests(self):
        self.assertRegex(self.output, "assert_fail")
        self.assertRegex(
            self.output,
        ...
        self.assertRegex(self.output, "assert_ix_equal\n fails for different value")
        self.assertRegex(
            self.output,
        ...
        self.assertRegex(self.output, "assert_bytes_not_equal\n fails for same value")
        self.assertRegex(self.output, "assert_z_set\n fails when zero flag reset")
        self.assertRegex(self.output, "assert_z_reset\n fails when zero flag set")
        self.assertRegex(self.output, "assert_carry_set\n fails when carry flag reset")
        self.assertRegex(self.output, "assert_carry_reset\n fails when carry flag set")
        self.assertRegex(self.output, "assert_s_set\n fails when signed flag reset")
        self.assertRegex(self.output, "assert_s_reset\n fails when signed flag set")
        self.assertRegex(self.output, "assert_p_v_set\n fails when overflow flag reset")
        self.assertRegex(self.output, "assert_p_v_reset\n fails when overflow flag set")
        self.assertRegex(
        ...
        self.assertRegex(self.output, "assert_a_not_equal")
        self.assertRegex(self.output, "assert_b_not_equal")
        self.assertRegex(self.output, "assert_c_not_equal")
        self.assertRegex(self.output, "assert_d_not_equal")
        self.assertRegex(self.output, "assert_e_not_equal")
        self.assertRegex(self.output, "assert_h_not_equal")
        self.assertRegex(self.output, "assert_l_not_equal")
        self.assertRegex(self.output, "assert_hl_not_equal")
        self.assertRegex(self.output, "assert_bc_not_equal")
        self.assertRegex(self.output, "assert_de_not_equal")
        self.assertRegex(self.output, "assert_ix_not_equal")
        self.assertRegex(self.output, "assert_a_is_zero")
        self.assertRegex(self.output, "assert_a_is_not_zero")
        self.assertRegex(self.output, "assert_byte_not_equal")
        self.assertRegex(self.output, "assert_word_not_equal")
        self.assertRegex(self.output, "assert_str_not_equal")
...
class TestHexDisplay(unittest.TestCase):
    ...
    def test_hex_values_are_displayed_correctly(self):
        ...
        self.assertRegex(
            self.output, "fails for different value\n\nExpected: ACDC, Actual: FFFF"
        )
        self.assertRegex(
            self.output,
...
class TestVerbose(unittest.TestCase):
    ...
    def test_descriptions_displayed_correctly(self):
        self.assertRegex(self.output, "assert_pass\n passes test")
        self.assertRegex(self.output, "assert_a_equal\n passes for same value")
...
def run_zx_spec(tape):
    cmd_line = "{0} --no-sound --zxprinter --printer --tape {1} --auto-load --no-autosave-settings".format(
        os.getenv("FUSE", "fuse"), tape
    )
    proc = subprocess.Popen(cmd_line, shell=True, preexec_fn=os.setsid)
